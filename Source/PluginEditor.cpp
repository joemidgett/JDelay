...
void JDelayDryLevelLookAndFeel::drawRotarySlider(juce::Graphics& g,
                                                 int x,
                                                 int y,
                                                 int width,
                                                 int height,
...
void JDelayDelayTimeLookAndFeel::drawRotarySlider(juce::Graphics& g,
                                                 int x,
                                                 int y,
                                                 int width,
                                                 int height,
...
void JDelayFeedbackLookAndFeel::drawRotarySlider(juce::Graphics& g,
                                                 int x,
                                                 int y,
                                                 int width,
                                                 int height,
...
void JDelayRatioLookAndFeel::drawRotarySlider(juce::Graphics& g,
                                              int x,
                                              int y,
                                              int width,
                                              int height,
